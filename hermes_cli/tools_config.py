...
CONFIGURABLE_TOOLSETS = [
    ...
    ("video_pipeline",  "🎞️  Video Pipeline",          "video_pipeline (subtitles, titles, thumbnails — needs ffmpeg)"),
...
#
# Video pipeline is off by default — it needs a local ffmpeg install and is
# only useful to people editing video. Its check_fn keeps the schema hidden
# when ffmpeg is missing even after the user enables the toolset.
_DEFAULT_OFF_TOOLSETS = {"homeassistant", "spotify", "discord", "discord_admin", "video", "video_gen", "video_pipeline", "x_search", "a2a"}
